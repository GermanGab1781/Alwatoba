...
export default function Navbar(){
  ...
  return (
    ...
    animate={{opacity:1}} exit={{opacity:0}}>
      ...
      {/* Nav Opener */}      
        <button onClick={()=>setNavButton(!navButton)} className="row-start-0 sm:col-start-9 col-start-8 hover:text-slate-50 sm:ml-10 ml-4  transition-all delay-75 px-10 "><FaBars className="sm:w-10 sm:h-12 h-10 w-8" /></button>      
      {/* Nav Items */}
