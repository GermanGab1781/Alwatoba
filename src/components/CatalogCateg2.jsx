...
export default function CatalogCateg2() {
  return (
    <motion.div className="flex flex-wrap gap-y-10 gap-x-5 mt-5 max-h-full max-w-full place-content-start sm:text-xl custom-Color4 font-semibold px-10 py-5" initial={{opacity:0}} animate={{opacity:1}} exit={{opacity:0}}>
