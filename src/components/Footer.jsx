...
export default function Footer() {
  ...
  return (
    <div className="md:grid md:grid-cols-6 flex flex-col bg-slate-50 border-t-2 pt-16 pb-10 z-30 relative">
      ...
      <div className="md:row-start-1 md:col-start-1 flex flex-col md:col-span-4 md:ml-20 ml-5 md:text-3xl md:mb-0 mb-10 text-xl place-items-center custom-Color3">
      ...
      {/* Redes y Contacto */}
      <div className="md:grid md:grid-rows-2 md:row-start-1 md:col-start-5 md:col-span-2 md:ml-20 ml-5 text-center md:text-start md:text-3xl text-xl">
