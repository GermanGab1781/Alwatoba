...
export default function CatalogAutoctonaComplementos() {
  ...
  return (
    <motion.div className="md:pt-10 pt-20 grid grid-cols-8 custom-ColorMain text-center" initial={{opacity:1}} animate={{opacity:1}} exit={{opacity:1}}>
        <span className="row-start-1 sm:col-start-5 sm:col-span-3 col-start-5 col-span-3 font-bold md:text-7xl sm:text-5xl text-4xl sm:mt-5 py-5 rounded-t-3xl font-mathlete">
          Complementos
        </span>
         {/* Link Tree */}
        ...
        <Link className={menuButton ?"z-10 opacity-100 visible hover:text-slate-200 hover:scale-105 border-y-2 custom-BorderColor3 transition-all ease-in-out duration-300 sm:delay-75 delay-300":"opacity-0 invisible transition-all ease-in-out duration-300"} to='Categ2'>Palo Santo</Link>
        ...
        <Link className={menuButton ?"z-10 text-slate-100 opacity-100 visible hover:text-slate-200 hover:scale-105 border-y-2 custom-BorderColor3 transition-all ease-in-out duration-300 sm:delay-75 delay-300":"opacity-0 invisible transition-all ease-in-out duration-300"} initial={{opacity:0,transition:{duration:1}}} animate={{opacity:2,transition:{duration:1.5}}} exit={{opacity:0}} to='/Catalog/Autoctona'>Volver</Link>
