  ...
  return (
    <motion.div className="grid bg-slate-100 md:gap-y-4 gap-y-5 md:pt-15 pt-20 place-items-center" initial={{opacity:0}} animate={{opacity:1}} exit={{opacity:0}}>
      ...
      <div className='row-start-2 custom-BgColor4 w-full text-center py-16 my-10'>
        ...
        <div className='mt-10'>
          <NavLink className="hover:shadow-xl hover:shadow-black text-center custom-BgColor1 custom-ColorMain xl:text-2xl font-semibold  xl:mt-10 mt-5 xl:p-5 p-5 rounded-xl font-comfortaa" to="/Catalog/All">VER CATÁLOGO</NavLink>
        </div>
      </div>
