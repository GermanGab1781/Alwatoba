...
export default function CatalogColeccionesEscencia() {
  ...
  return (
    <motion.div className="md:pt-10 pt-20 grid grid-cols-8 custom-ColorMain text-center" initial={{opacity:1}} animate={{opacity:1}} exit={{opacity:1}}>
        <span className="row-start-1 sm:col-start-5 sm:col-span-3 col-start-4 col-span-3 font-bold md:text-7xl sm:text-5xl text-4xl sm:mt-5 py-5 rounded-t-3xl font-mathlete whitespace-nowrap">
          Escencia Imperfecta
        </span>
        {/* Link Tree */}
