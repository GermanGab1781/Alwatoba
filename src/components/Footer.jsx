    ...
    <div className="flex md:flex-row flex-col gap-y-5 py-5 place-content-evenly text-center md:text-3xl text-xl">
      ...
      <div className=''>
        ...
        <div className="flex flex-col gap-y-2 pl-2 ml-7 text-start md:place-items-start place-items-center text-xl custom-Color3">
          ...
          <a className="relative" href="https://www.instagram.com/german_gabriel__" target="_blank" rel='noreferrer'><HiLocationMarker className="absolute -left-8 bottom-1 h-5 w-10 custom-Color3" />560 Av. Maradona</a>
          <a className="relative" href="https://wa.me/2215770092?text=Hola,quiero devolver mi producto" target="_blank" rel='noreferrer'><HiReceiptRefund className="absolute -left-8 bottom-1 h-5 w-10 custom-Color3" />Boton de arrepentimiento</a>
        </div>
      </div>
