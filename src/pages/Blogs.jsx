  ...
  return (
    <motion.div className="grid py-24 custom-Color3 custom-BgColor4 font-comfortaa">
      ...
      <div className="flex flex-col gap-y-3 relative row-start-2 md:mx-20 mx-3 h-fit p-4 my-1 md:text-2xl text-lg"> 
        <span>
          <span className="xl:ml-3 ml-1 font-bold custom-ColorMain">Somos Mariana y Yandyra Chagra</span>
        ...
        <span>
          <span className="xl:ml-3 ml-1 font-bold custom-ColorMain">Fue así</span> que nos identificamos con la definición “Tierra de Guerreros” - “Tierra Toba” - “AlwaToba” y un “Nuevo comienzo” de la herencia materna. 
        </span>
        <span>
        ...
        <span>
          <span className="xl:ml-3 ml-1 font-bold custom-ColorMain">Diseñamos</span> inspiradas en la naturaleza que nos rodea, creando y co-creando con las artesanas indígenas, objetos de lujo con diseño contemporáneo y siempre vigente, realizados con materiales naturales, durables y sustentables.
        </span>
