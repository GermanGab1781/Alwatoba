  ...
  return (
    ...
    animate={{opacity:1}} exit={{opacity:0}}>
      ...
      <div className={navButton 
        ...
        <>
        <NavLink className="text-center cursor-pointer md:text-5xl text-4xl custom-Color4 transition-all delay-75" to="/Alwatoba" onClick={()=>setNavButton(!navButton)}>Inicio</NavLink>
        <NavLink className="hover:text-slate-50 md:text-3xl transition-all delay-75" to="/Catalog/All" onClick={()=>setNavButton(!navButton)}>Catalogo</NavLink>
        <NavLink className="hover:text-slate-50 md:text-2xl transition-all delay-75" to="/Blogs" onClick={()=>setNavButton(!navButton)}>Nosotras</NavLink>
        <NavLink className="hover:text-slate-50 md:text-2xl transition-all delay-75" to="/Catalog/Autoctona/all" onClick={()=>setNavButton(!navButton)}>Indumentaria Autoctona</NavLink>
        <NavLink className="hover:text-slate-50 md:text-2xl transition-all delay-75" to="/Catalog/Colecciones/all" onClick={()=>setNavButton(!navButton)}>Colecciones</NavLink>
        <NavLink className="hover:text-slate-50 md:text-2xl transition-all delay-75" to="/Catalog/ArteYDisenio/all" onClick={()=>setNavButton(!navButton)}>Arte y Diseño</NavLink>
        <span className="text-center cursor-pointer md:text-5xl text-4xl custom-Color4 transition-all delay-75 mt-10" onClick={()=>setNavButton(!navButton)}>Cerrar</span>
        </>
