  ...
  return (
    <div>
      <div className="md:grid md:grid-cols-6 flex flex-col bg-slate-50 border-t-2 pt-16 pb-10 z-30 relative">
        ...
        <div className="md:row-start-1 md:col-start-1 flex flex-col md:col-span-4 md:ml-20 ml-0 md:text-3xl md:mb-0 mb-10 text-xl place-items-center custom-Color3">
          <span className=''>Medios de Pago y Envio</span>
          <span className=' text-black md:text-2xl text-lg text-center'>Arreglalo con nosotros contactandonos </span>
          <span className=''>&#8595;&#8595;&#8595;</span>
          <div onClick={contactMethods} className="relative cursor-pointer xl:w-1/4 group xl:mt-8 mt-2">
            ...
            <img className="p-1 md:w-full md:h-full  group-hover:scale-150 group-active:scale-150 transition-all  border border-black" src={require("../media/MediosdePago/acordar.png")} alt="Metodo de pago" />
          </div>
        </div>
        {/* Redes y Contacto */}
        <div className="md:grid md:grid-rows-2 md:row-start-1 md:col-start-5 md:col-span-2 md:ml-20 ml-0 text-center md:text-start md:text-3xl text-xl">
